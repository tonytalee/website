...
params:
  ...
  grr_criteria: params$grr_criteria
  rptTitle: params$rptTitle
  rptDescrip: params$rptDescrip
  systemId: systemId
  author: author
title: "`r rptTitle`"
---
...
```{r grr_table, results= 'asis', dpi=72, fig.width= 10, fig.asp = 0.618}
# show compoent plot
li_grr$p_comp
...
```{r Xbar-R_analysis, include= FALSE}
...
```{r x_r_chart, results='asis', dpi=72, fig.width= 10, fig.asp = 0.618}
li_grr$li_spc$p
```

## Measurement by operators

```{r operator, results='asis'}
cat("<div class= 'listx'>")
